...
const History = ({ isActive, className, size = 29 }: { isActive?: boolean, className?: string, size?: number }) => {
    return (
        <Svg width={size} height={size} viewBox="0 0 29 29" fill="none" className={className}>
