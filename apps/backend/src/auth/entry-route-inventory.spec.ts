...
const ENTRY_ALLOWED: readonly string[] = [
  ...
  'POST /account/recovery/primary/challenge',
  'POST /account/recovery/primary/verify',
  'POST /account/recovery/primary/start',
  'POST /account/recovery/primary/next',
  'POST /account/recovery/primary/submit',
...
const CLOSED_TO_ENTRY: readonly string[] = [
  ...
  'POST /fiat/banking/recipients/candidates',
  'POST /fiat/banking/recipients/resolve',
